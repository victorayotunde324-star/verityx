...
export default function Services() {
  ...
  return (
    <main>
      ...
      {/* SERVICES GRID (UPGRADED GLASS STYLE) */}
  ...
  <div className="max-w-6xl mx-auto grid md:grid-cols-2 lg:grid-cols-3 gap-8">
    ...
    {[
      ...
      },
      {
        ...
        desc: "We manage and grow your social media presence with strategic content that engages your audience and builds a loyal following. Our focus is on consistent visibility, audience interaction, and turning followers into readers."
      },
      {
        title: "SEO & Visibility",
        desc: "We implement proven SEO strategies to boost your online presence across search engines and digital platforms. By improving your discoverability, we help your book and brand reach a wider audience organically and sustainably."
      }
    ].map((service, i) => (

      <div
        key={i}
        className="relative group rounded-2xl overflow-hidden backdrop-blur-xl bg-white/30 border border-white/40 shadow-lg hover:shadow-2xl transition duration-500 p-8"
      >
        ...
        <div className="mb-20">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            ...
            {[
              ...
              { i: 2, link: "https://www.amazon.com/dp/B0D5YZLT47?_encoding=UTF8&psc=1&ref_=cm_sw_r_ffobk_cp_ud_dp_RRQPYYGB4E4NPXJH77W8_1&bestFormat=true" },
      ...
      {selected && (
        ...
        >
          <img
            src={selected}
            className="max-w-6xl max-h-[90vh] rounded-lg shadow-2xl"
          />
        </div>
      )}
  ...
  <div className="grid md:grid-cols-2 gap-10 max-w-5xl mx-auto">
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="bg-white/80 backdrop-blur-md p-4 rounded-full text-[#0A1931] text-xl font-bold">
          ▶
        </div>
      </div>
